    ...
    createSignature(msg, keyPair) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((res) => __awaiter(this, void 0, void 0, function* () {
                ...
                crypto_1.randomFillSync(msg_bytes);
                let shaKey = crypto_1.createHash('sha256').update(keyPair.PrivateKey).digest();
                let temp = Buffer.concat([msg_bytes, shaKey, msg]);
                let preKey = crypto_1.createHash('sha512').update(temp).digest();
