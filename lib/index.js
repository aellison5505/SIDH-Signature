    ...
    createSignature(msg, keyPair) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((res) => __awaiter(this, void 0, void 0, function* () {
                ...
                let shaKeyHash = yield shake256(preShaKeyHash, 64);
                //let publicKeyHash = createHash('sha256').update(keyPair.PublicKey).digest();
                let publicKeyHash = yield shake256(keyPair.PublicKey, 32);
                ...
                private_key_A = yield shake256(Buffer.concat([keyPair.PublicKey, shaKeyHash, msg]), 47);
                //let private_key_A = Buffer.alloc(47);
    ...
    verifySignature(msg, sig) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((res, err) => __awaiter(this, void 0, void 0, function* () {
                ...
                let signerPubKeyHash = yield shake256(signerPubKey, 32);
                ...
                let private_key_A = Buffer.alloc(47);
                private_key_A = yield shake256(Buffer.concat([signerPubKey, shaKeyHash, msg]), 47);
                //preKey.copy(private_key_A,0,0,47);
                private_key_A[46] &= 0x0F;
